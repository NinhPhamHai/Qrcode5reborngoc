...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 38
    new-instance p1, Lcom/skydoves/colorpickerview/sliders/AlphaTileDrawable;

    invoke-direct {p1}, Lcom/skydoves/colorpickerview/sliders/AlphaTileDrawable;-><init>()V

    iput-object p1, p0, Lcom/skydoves/colorpickerview/sliders/AlphaSlideBar;->drawable:Lcom/skydoves/colorpickerview/sliders/AlphaTileDrawable;
...
.method protected getAttrs(Landroid/util/AttributeSet;)V
    ...
    .line 60
    :try_start_0
    sget v0, Lcom/skydoves/colorpickerview/R$styleable;->AlphaSlideBar_selector_AlphaSlideBar:I
    ...
    iput-object v0, p0, Lcom/skydoves/colorpickerview/sliders/AlphaSlideBar;->selectorDrawable:Landroid/graphics/drawable/Drawable;

    .line 62
    :cond_0
    sget v0, Lcom/skydoves/colorpickerview/R$styleable;->AlphaSlideBar_borderColor_AlphaSlideBar:I
    ...
    iget v1, p0, Lcom/skydoves/colorpickerview/sliders/AlphaSlideBar;->borderColor:I

    invoke-virtual {p1, v0, v1}, Landroid/content/res/TypedArray;->getColor(II)I

    move-result v0

    iput v0, p0, Lcom/skydoves/colorpickerview/sliders/AlphaSlideBar;->borderColor:I

    .line 64
    :cond_1
    sget v0, Lcom/skydoves/colorpickerview/R$styleable;->AlphaSlideBar_borderSize_AlphaSlideBar:I
    ...
    iget v1, p0, Lcom/skydoves/colorpickerview/sliders/AlphaSlideBar;->borderSize:I

    invoke-virtual {p1, v0, v1}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v0

    iput v0, p0, Lcom/skydoves/colorpickerview/sliders/AlphaSlideBar;->borderSize:I
    :try_end_0
...
.method public onInflateFinished()V
    ...
    .line 102
    invoke-virtual {p0, v0}, Lcom/skydoves/colorpickerview/sliders/AlphaSlideBar;->updateSelectorX(I)V
...
.method protected onSizeChanged(IIII)V
    ...
    iput-object p1, p0, Lcom/skydoves/colorpickerview/sliders/AlphaSlideBar;->backgroundBitmap:Landroid/graphics/Bitmap;

    .line 75
    new-instance p1, Landroid/graphics/Canvas;

    iget-object p2, p0, Lcom/skydoves/colorpickerview/sliders/AlphaSlideBar;->backgroundBitmap:Landroid/graphics/Bitmap;

    invoke-direct {p1, p2}, Landroid/graphics/Canvas;-><init>(Landroid/graphics/Bitmap;)V

    .line 76
    iget-object p2, p0, Lcom/skydoves/colorpickerview/sliders/AlphaSlideBar;->drawable:Lcom/skydoves/colorpickerview/sliders/AlphaTileDrawable;
    ...
    invoke-virtual {p2, v0, v0, p3, p4}, Lcom/skydoves/colorpickerview/sliders/AlphaTileDrawable;->setBounds(IIII)V

    .line 77
    iget-object p2, p0, Lcom/skydoves/colorpickerview/sliders/AlphaSlideBar;->drawable:Lcom/skydoves/colorpickerview/sliders/AlphaTileDrawable;

    invoke-virtual {p2, p1}, Lcom/skydoves/colorpickerview/sliders/AlphaTileDrawable;->draw(Landroid/graphics/Canvas;)V
